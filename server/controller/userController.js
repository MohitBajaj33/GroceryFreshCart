...
export const sendOtp = async (req, res) => {
    ...
    try {
        ...
        // Email Options
        const mailOptions = {
          from: `"Bajaj Grocery Store" <no-reply@bajajgrocery.com>`, // Corrected format
          to: email,
          subject: "Your OTP Code - Bajaj Grocery Store",
          html: `
              <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 500px; margin: auto; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
                  <h2 style="color: #2c3e50; text-align: center;">Bajaj Grocery Store</h2>
                  ...
                  <p style="font-size: 12px; color: #888; text-align: center;">&copy; ${new Date().getFullYear()} Bajaj Grocery Store. All rights reserved.</p>
              </div>
          `,
      };
